...
public class DischargedportalgunItem extends Item {
	public DischargedportalgunItem() {
		super(new Item.Properties().tab(RickAndMortyModTabs.TAB_RICK_AND_MORTY_PORTAL).stacksTo(1).rarity(Rarity.EPIC));
	}

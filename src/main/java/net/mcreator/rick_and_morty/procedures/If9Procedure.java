...
public class If9Procedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == RickAndMortyModItems.PORTALGUN.get()
				&& (entity.getCapability(RickAndMortyModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new RickAndMortyModVariables.PlayerVariables())).quantity == 9) {
			return true;
		}
		return false;
	}
